                    ...
                    <Center>
                        <VStack>
                            <Box textAlign={'center'}>
                                ...
                                <Text fontFamily={"Poppins"} fontSize='30px' fontWeight={500}> Extracurriculars. </Text>
                            </Box>
                            <Box paddingTop={'50%'} textAlign={'center'}>
                                <Text fontFamily={"Poppins"} fontSize='24px' fontWeight={500}> Welcome to FindECs</Text>
                                <Text fontFamily={"Poppins"} fontSize='16px' fontWeight={500}> The largest database of
                                    extracurriculars </Text>
                                <Text fontFamily={"Poppins"} fontSize='16px' fontWeight={500}> in the world. </Text>
                            ...
                            <Box paddingTop={'60px'}>
                                <Center>
                                    <Button borderRadius={'20px'} variant={'solid'} fontFamily={'Poppins'}
                                            ...
                                            color={'white'} width={'175px'}> GET STARTED</Button>
                                </Center>
                            </Box>
                        </VStack>
                    </Center>
